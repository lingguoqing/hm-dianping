...
public class FollowServiceImpl extends ServiceImpl<FollowMapper, Follow> implements IFollowService {
    ...
    public Result follow(Long followUserId, Boolean isFollow) {
        ...
        if (isFollow) {
            ...
            boolean isSuccess = remove(new QueryWrapper<Follow>().eq("userId", userId).eq("followUserId", followUserId));
            if (isSuccess) {
    ...
    public Result isfollow(Long followUserId) {
        ...
        String keyuserId = FOLLOWS + userId;
        String keyfollowUserId = FOLLOWS + followUserId;

        Set<String> intersect = stringRedisTemplate.opsForSet().intersect(keyuserId, keyfollowUserId);
